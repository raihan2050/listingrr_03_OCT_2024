<div class="header-element notifications-dropdown">
    ...
    <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
        ...
        <ul class="list-unstyled p-2" id="header-notification-scroll" data-simplebar="init">
                    ...
                    <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                        <div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: auto; overflow: hidden;">
                            <div class="simplebar-content" style="padding: 8px;">
                                <li class="dropdown-item d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                        <a href="notification-list.html">
                                            <p class=" mb-0 fw-semibold text-dark">Gladys Dare <span class="text-muted">commented on</span> Ecosystems</p>
                                ...
                                <li class="dropdown-item d-flex align-items-start">
                                    <div class="pe-2">
                                        <span class="avatar avatar-md bg-pink-transparent avatar-rounded">
                                            <i class="fe fe-check fs-18"></i>
                                        </span>
                                    </div>
                                    <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                        <a href="notification-list.html">
                                            <p class="text-dark mb-0 fw-semibold">Laurel <span class="text-muted">donated</span> <span class="text-success fw-semibold">$100</span> <span class="text-muted">for</span> carbon removal</p>
                                ...
                                <li class="dropdown-item d-flex align-items-start">
                                    <div class="pe-2"> <span class="avatar avatar-md bg-warning-transparent avatar-rounded">
                                        <i class="ti ti-circle-check fs-18"></i>
                                        </span>
                                    </div>
                                    <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                        <a href="notification-list.html">
                                            <p class="mb-0 fw-semibold text-dark">Sunny Grahm <span class="text-muted">voted for</span> carbon capture </p>
                                ...
                                <li class="dropdown-item d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                        <a href="notification-list.html">
                                            <p class=" mb-0 fw-semibold text-dark">Laurel <span class="text-muted">donated</span> <span class="text-success fw-semibold">$100</span> <span class="text-muted">for</span> carbon removal</p>
