<form data-target_pulse="socialLoginPulse" class="socialLoginForm">
    <div class="row gy-4">
        ...
        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 mt-5 text-align-right">
            <button type="button"
                    class="btn btn-primary-gradient label-btn label-end mt-3 socialLoginPulse submitForm"
                    data-targetForm="socialLoginForm">
