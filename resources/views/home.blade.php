                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div>
                                ...
                                <div class="fs-30 fw-semibold mb-0 lh-1">3,456</div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <div class="fs-12 text-muted mb-5">Overview of this month</div>
                                    <div class="fs-30 fw-semibold mb-0 lh-1">4,738</div>
                                </div>
                                <div class="text-end d-flex flex-column align-items-center">
                                    <label class="custom-switch mb-5">
                                    ...
                                    <span class="text-secondary lh-1 mt-3 fs-26">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <div class="fs-12 text-muted mb-5">Overview of this month</div>
                                    <div class="fs-30 fw-semibold mb-0 lh-1">6,738</div>
                                </div>
                                <div class="text-end d-flex flex-column align-items-center">
                                    <label class="custom-switch mb-5">
                                        <input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input">
                                    ...
                                    <span class="text-warning lh-1 mt-3 fs-26">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <div class="fs-12 text-muted mb-5">Overview of this month</div>
                                    <div class="fs-30 fw-semibold mb-0 lh-1">$8,963 <i class=""></i></div>
                                </div>
                                <div class="text-end d-flex flex-column align-items-center">
                                    <label class="custom-switch mb-5">
                                        <input type="checkbox"
                                    ...
                                    <span class="text-danger lh-1 mt-3 fs-26">
                ...
                <div class="row">
                    <div class="col-lg-4 border-end">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <p class="mb-0 fw-semibold text-muted-dark">Total Purchase</p>
                                    <h3 class="mt-2 mb-1 text-dark fw-semibold">$7,483</h3>
                                    <p class="text-muted fs-12 mb-0">
                                        <span class="text-body fw-semibold">
                                            <i class="fa fa-arrow-up text-success me-1"> </i>23%
                                        </span> in this year
                                    </p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <h3 class="mt-2 mb-1 text-dark fw-semibold">65,457</h3>
                                    <p class="text-muted fs-12 mb-0">
                                        <span class="text-body fw-semibold">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <h3 class="mt-2 mb-1 text-dark fw-semibold">$6,128</h3>
                                    <p class="text-muted fs-12 mb-0">
                                        <span class="text-body fw-semibold">
        ...
        <div class="col-xxl-5 col-lg-12 col-md-12">
            <div class="card d-inline-block overflow-hidden">
                ...
                <div class="card-body pb-0">
                    <div   div id="sales-country-wise"></div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-6 border-end">
                            ...
                            <div class="d-flex justify-content-center align-items-center mb-3">
                                ...
                                <span class="text-success fw-semibold mt-1">
                        ...
                        <div class="col-6">
                            ...
                            <div class="d-flex justify-content-center align-items-center mb-3">
                                ...
                                <span class="text-danger fw-semibold mt-1">
                        ...
                        <table class="table border-0 mb-0 text-nowrap">
                            ...
                            <tbody>
                                <tr class="border-bottom">
                                    ...
                                    <td>
                                        <div class="progress progress-xs">
                                            <div class="progress-bar progress-bar-striped progress-bar-animated bg-primary w-50 rounded">
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-end pe-5">
                                        <div>
                                            <span class="btn btn-sm btn-outline-primary bg-primary-transparent">50%</span>
                                        </div>
                                    </td>
                                </tr>
                                <tr class="border-bottom">
                                    ...
                                    <td>
                                        <div class="progress progress-xs">
                                            <div class="progress-bar progress-bar-striped progress-bar-animated bg-secondary w-20 rounded">
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-end pe-5">
                                        <div>
                                            <span class="btn btn-sm btn-outline-secondary bg-secondary-transparent">20%</span>
                                        </div>
                                    </td>
                                </tr>
                                <tr class="border-bottom">
                                    ...
                                    <td>
                                        <div class="progress progress-xs">
                                            <div class="progress-bar progress-bar-striped progress-bar-animated bg-info w-30 rounded">
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-end pe-5">
                                        <div>
                                            <span class="btn btn-sm btn-outline-info bg-info-transparent">30%</span>
                                        </div>
                                    </td>
                                </tr>
                                <tr class="border-bottom-0">
                                    ...
                                    <td>
                                        <div class="progress progress-xs">
                                            <div class="progress-bar progress-bar-striped progress-bar-animated bg-pink w-50 rounded">
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-end pe-5">
                                        <div>
                                            <span class="btn btn-sm btn-outline-pink bg-pink-transparent">45%</span>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                ...
                <div class="card-body">
                    <div class="timeline-label">
                        <div class="sales-activity mb-4 fs-13">
                            ...
                            <p class="mb-0 ms-5 text-muted fs-12">
                                <a href="javascript:void(0);" class="text-azure fw-semibold p-0">Jhon124</a>
                                successfully Signed
                            </p>
                        </div>
                        <div class="sales-activity mb-4">
                            ...
                            <p class="mb-0 ms-5 text-muted fs-12">
                                User
                                <a href="javascript:void(0);" class="text-azure">Charlie_T</a>
                                checked out
                                <a href="javascript:void(0);" class="text-purple">Item #42</a>.
                                <a href="javascript:void(0);" class="text-success fw-semibold">View</a>
                            </p>
                        </div>
                        <div class="sales-activity mb-4">
                            ...
                            <p class="mb-0 ms-5 text-muted fs-12">
                                User
                                <a href="javascript:void(0);" class="text-azure">Michael85</a>
                                Submitted a ticket
                                <a href="javascript:void(0);" class="text-success fw-semibold">Details</a>
                            </p>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table id="data-table" class="table border p-0 text-nowrap mb-0">
                            <thead class="bg-light text-dark">
                                <tr>
                                    <th class="fw-semibold fs-14 border-bottom-0 w-5">Order ID</th>
                                    <th class="fw-semibold fs-14 border-bottom-0">Customer</th>
                                    <th class="fw-semibold fs-14 border-bottom-0">Order Date</th>
                                    <th class="fw-semibold fs-14 border-bottom-0">Product name</th>
                                    <th class="fw-semibold fs-14 border-bottom-0">Price</th>
                                    <th class="fw-semibold fs-14 border-bottom-0">Status</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="border-bottom">
                                    ...
                                    <td class="fs-13 fw-semibold text-dark">
                                        <i class="fe fe-calendar me-2"></i>20-11-2020
                                    </td>
                                    ...
                                    <td class="fs-15 fw-semibold">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span class="badge text-white bg-danger fw-semibold fs-11">Out Stock</span>
                                            <div class="dropdown">
                                ...
                                <tr class="border-bootom">
                                    ...
                                    <td class="fs-13 fw-semibold text-dark">
                                        <i class="fe fe-calendar me-2"></i>19-11-2020
                                    </td>
                                    <td class="fs-13 fw-semibold text-dark ">Jeans</td>
                                    <td class="fs-13 fw-semibold text-dark ">$56.035</td>
                                    <td class="fs-15 fw-semibold">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span class="badge text-white bg-success fw-semibold fs-11">In
                                                Stock
                                            </span>
                                            <div class="dropdown">
                                                <a href="" class="fw-semibold" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
